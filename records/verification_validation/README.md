...
All records were regenerated 2026-08-30 from runs on the current `CONSULT_###` casebank (`rig dossier`, battery `gemini_compare_all`, seed 1, pack_hash `58e1058bc0b4b9f1…`): runs `63eec9c7d2ca0c08` (2.5-flash), `a8ccc6fac866e8d3` (3.5-flash), `84ef279cb7a91160` (3.7-flash). The V&V records produced before the 2026-08-30 relabel (pack was then labeled "MedBench") embedded the old case ids and were deliberately not carried over; they remain only in the superseded `clinical-eval-medbench` repo. All records here are **DRAFT / unsigned** pending clinical review.
